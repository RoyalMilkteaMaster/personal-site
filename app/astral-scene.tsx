 ...
 useEffect(()=>{
  ...
  const render=(now:number)=>{
   ...
   if(targets.length){
    ...
    }else if(cmd.pose!==active||skipNow){transitionDuration=reduced||skipNow?1:1250;morph.retarget(targets[cmd.pose],clock,transitionDuration,foreground,true);surfaceFrom=visualSurface;phase='morph';surfaceAt=clock;active=cmd.pose;}
   }
